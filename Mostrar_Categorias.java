...
public class Mostrar_Categorias extends javax.swing.JFrame {
    ...
    void mostrarCategorias() {
        String [] titulos = {"idCategoria","nombre"};
        ...
        while (rs.next()) {
                re[0] = rs.getString("idCategoria");
                re[1] = rs.getString("nombre");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mostrar_Categorias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Mostrar_Categorias().setVisible(true);
            }
        });
    }
